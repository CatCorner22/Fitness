  ...
  return (
    <AppShell user={user} profile={profile}>
      ...
      <p className="mt-3 max-w-2xl text-muted">
        Multiple ways in: short cue, numbered steps, diagram, photo, illustrated plate, sultry voice, video. Pick
        the channel that lands. Skip the rest. Nothing in a module is hidden.
      </p>
